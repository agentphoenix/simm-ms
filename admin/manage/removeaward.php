...
Last Modified: 2007-04-27 1229 EST
**/
...
?>
	...
	<div class="body">
		...
		while( $userFetch = mysql_fetch_assoc( $getCrewResult ) ) {
			...
			echo "<a href='" . $webLocation . "admin.php?page=manage&sub=removeaward&crew=" . $userFetch['crewid'] . "'>" . $userFetch['rankName'] . " " . $userFetch['firstName'] . " " . $userFetch['lastName'] . "</a><br />";
				...
				while( $awardArray = mysql_fetch_array( $pullAwardResult ) ) {
					...
					echo "<tr class='fontNormal'>";
						echo "<td width='70'>";
							...
							echo "<img src='" . $webLocation . "images/awards/" . $awardImage . "' alt='" . $awardName . "' border='0' />";
							echo "</a>";
						echo "</td>";
