...
Last Modified: 2007-08-08 1814 EST
**/
...
switch( $step ) {
	...
	/*
		step 2 attempts to write the variables file that the admin provided
...
?>";
	...
	/* step 3 handles creating the database structure */
	case 3:
	...
	/*
		step 4 handles inserting the necessary data into the database that lines up
	...
	*/
	...
	/*
		step 5 handles inserting the admin's character into the database, setting their
	...
	*/
	...
	/*
		step 6 handles updating the globals that are set during step 5, including ship name,
