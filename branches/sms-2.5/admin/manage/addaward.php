...
Last Modified: 2007-04-22 1601 EST
**/
...
?>
	...
	<div class="body">
		...
		while( $userFetch = mysql_fetch_assoc( $getCrewResult ) ) {
			...
			echo "<a href='" . $webLocation . "admin.php?page=manage&sub=addaward&crew=" . $userFetch['crewid'] . "'>" . $userFetch['rankName'] . " " . $userFetch['firstName'] . " " . $userFetch['lastName'] . "</a><br />";
