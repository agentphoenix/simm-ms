...
Last Modified: 2007-07-10 1052 EST
**/
	...
	<div class="body">
		...
		<form method="post" action="<?=$webLocation;?>admin.php?page=manage&sub=messages">
			<table>
				...
				<tr>
					<td class="tableCellLabel">
						Player Acceptance Email<br /><br />
						<span class="fontSmall"><b class="yellow">Define a form letter here that will
						be displayed when you accept a player.  Before accepting the player, you will
						have the option of changing the letter to be more specific to the situation.</b></span>
					</td>
					<td>&nbsp;</td>
					<td>
				...
				<tr>
					<td class="tableCellLabel">
						Player Rejection Email<br /><br />
						<span class="fontSmall"><b class="yellow">Define a form letter here that will
						be displayed when you reject a player.  Before rejecting the player, you will
						have the option of changing the letter to be more specific to the situation.</b></span>
					</td>
					<td>&nbsp;</td>
					<td>
