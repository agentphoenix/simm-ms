				...
				<table cellpadding="2" cellspacing="0" border="0">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center" width="150"><?php echo $req['php'][0];?></td>
							<td align="center" width="150" class="<?php echo $color;?>"><?php echo $req['php'][1];?></td>
						</tr>
						...
						<tr>
							...
							<td align="center" width="150"><?php echo $req['mysql'][0];?></td>
							<td align="center" width="150" class="<?php echo $color;?>"><?php echo $req['mysql'][1];?></td>
						</tr>
						...
						<tr>
							<td>
								<strong>PHP Short Open Tags</strong>
								<?php if(isset($explain)) { ?>
							...
							<td align="center" width="150"><?php echo $req['short_open_tag'][0];?></strong></td>
							<td align="center" width="150" class="<?php echo $color;?>">
